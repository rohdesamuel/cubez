...
int main(int, char* []) {
  ...
  vec2s ball{ (float)(qb_window_width() / 2), (float)(qb_window_height() / 2) };
  ...
  qb_light_enable(0, QB_LIGHT_TYPE_POINT);
  qb_light_enable(1, QB_LIGHT_TYPE_POINT);
  qb_light_enable(2, QB_LIGHT_TYPE_POINT);
  qb_light_enable(3, QB_LIGHT_TYPE_POINT);

  qb_light_point(0, { 1.f, 0.f, 0.f }, { 25.f, 25.f, 0.f }, 0.001f, 0.000001f, 2000.f);
  qb_light_point(1, { 0.f, 1.f, 0.f }, { (float)qb_window_width() - 25.f, 25.f, 0.f }, 0.001f, 0.000001f, 2000.f);
  qb_light_point(2, { 0.f, 0.f, 1.f }, { (float)qb_window_width() - 25.f, (float)qb_window_height() - 25.f, 0.f }, 0.001f, 0.000001f, 2000.f);
  qb_light_point(3, { 1.f, 0.f, 1.f }, { 25.f, (float)qb_window_height() - 25.f, 0.f }, 0.001f, 0.000001f, 2000.f);
  ...
  while (qb_loop(&callbacks, &args) != QB_DONE) {
    qbDrawCommands d = qb_draw_begin(perspective);
    ...
    //qb_draw_rotatef(d, -0.2f, 1.f, 0.f, 0.f);    
