...
glm::vec3 Support(const glm::vec3& a_origin, const glm::vec3& b_origin,
                  const qbCollider_* shape1, const qbCollider_* shape2, glm::vec3 d) {
  // d is a vector direction (doesn't have to be normalized)
  // get points on the edge of the shapes in opposite directions
  glm::vec3 p1 = a_origin + qb_collider_farthest(shape1, d);
  glm::vec3 p2 = b_origin + qb_collider_farthest(shape2, -d);
