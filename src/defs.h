...
struct qbComponentAttr_ {
  ...
  size_t(*onpack)(qbComponent component, const void* read, qbBuffer_* write, ptrdiff_t* pos);
  size_t(*onunpack)(qbComponent component, const void* read, qbBuffer_* write, ptrdiff_t* pos);
};
